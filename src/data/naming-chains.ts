...
export const NAMING_CHAINS: SurfaceBinding[] = [
  ...
  {
    envVar: 'PYR', lens: 'physics-elemental',
    era: '20th c', eraSort: 1928,
    name: 'Plasma',
    connotation: 'Fourth state of matter — ionised, luminous, electromagnetic.',
    source: 'Langmuir, 1928',
  },
  {
    envVar: 'PYR', lens: 'modern-wellness',
    era: '21st c', eraSort: 2026,
  ...
  // ════════════════════════════════════════════════════════════════
  {
    envVar: 'OCULUS', lens: 'egyptian',
    era: '~2400 BCE', eraSort: -2400,
    name: 'Eye of Horus / Eye of Ra',
    connotation: 'Protective seeing — restored wholeness made visible.',
    source: 'Pyramid Texts',
  },
  {
    envVar: 'OCULUS', lens: 'sanskrit-vedic',
    era: '~800 BCE', eraSort: -800,
    name: 'Drsti / Ajna', script: 'दृष्टि / आज्ञा',
    connotation: 'The gaze that perceives — and the third-eye chakra of insight.',
    source: 'Upanishads',
  },
  {
    envVar: 'OCULUS', lens: 'greek-classical',
    era: '~400 BCE', eraSort: -400,
    name: 'Ophthalmos / Theoria', script: 'ὀφθαλμός / θεωρία',
    connotation: 'Eye and seeing-as-contemplation — perception as participation.',
    source: 'Plato, Republic VII',
  },
  {
    envVar: 'OCULUS', lens: 'christian-mystical',
    era: '14th c', eraSort: 1370,
  ...
  {
    envVar: 'OCULUS', lens: 'jungian',
    era: '20th c', eraSort: 1935,
    name: 'Witnessing Self',
    connotation: 'Meta-cognitive ego — the self that observes its own contents.',
    source: 'Jung, Aion',
  },
  {
    envVar: 'OCULUS', lens: 'physics-elemental',
    era: '20th c', eraSort: 1927,
    name: 'Observer / Measurement',
    connotation: 'The act of observation that collapses superposition.',
    source: 'Copenhagen interpretation',
  },
  {
    envVar: 'OCULUS', lens: 'modern-wellness',
    era: '21st c', eraSort: 2026,
    name: 'Awareness',
  ...
  // ════════════════════════════════════════════════════════════════
  {
    envVar: 'DYAD', lens: 'egyptian',
    era: '~2500 BCE', eraSort: -2500,
    name: 'Geb & Nut',
    connotation: 'Earth and sky — the held tension that births a world.',
    source: 'Heliopolitan cosmogony',
  },
  {
    envVar: 'DYAD', lens: 'sanskrit-vedic',
    era: '~1000 BCE', eraSort: -1000,
    name: 'Shiva-Shakti / Dvaita', script: 'शिव-शक्ति',
    connotation: 'Static and dynamic — consciousness and its energy.',
    source: 'Tantric tradition',
  },
  {
    envVar: 'DYAD', lens: 'greek-classical',
    era: '~530 BCE', eraSort: -530,
    name: 'DYAS', script: 'δυάς',
    connotation: 'The Two — first emanation from the Monad.',
    source: 'Pythagoras',
  },
  {
    envVar: 'DYAD', lens: 'christian-mystical',
    era: '~1100 CE', eraSort: 1100,
  ...
  {
    envVar: 'DYAD', lens: 'jungian',
    era: '20th c', eraSort: 1934,
    name: 'Anima / Animus',
  ...
  {
    envVar: 'DYAD', lens: 'physics-elemental',
    era: '18th c', eraSort: 1785,
    name: 'Charge Polarity (+/-)',
    connotation: 'Coulomb opposites — the field that animates matter.',
    source: 'Coulomb, 1785',
  },
  {
    envVar: 'DYAD', lens: 'modern-wellness',
    era: '21st c', eraSort: 2026,
    name: 'Regulation',
  ...
  {
    envVar: 'HYDOR', lens: 'physics-elemental',
    era: '18th c', eraSort: 1781,
  ...
  {
    envVar: 'HYDOR', lens: 'modern-wellness',
    era: '21st c', eraSort: 2026,
    name: 'Root Healing',
  ...
  // ════════════════════════════════════════════════════════════════
  {
    envVar: 'MANDORLA', lens: 'egyptian',
    era: '~2000 BCE', eraSort: -2000,
    name: 'Akhet',
    connotation: 'Horizon — the gateway between worlds where sun is born.',
    source: 'Pyramid Texts',
  },
  {
    envVar: 'MANDORLA', lens: 'sanskrit-vedic',
    era: '~800 BCE', eraSort: -800,
    name: 'Yoni-Lingam',
  ...
  // ════════════════════════════════════════════════════════════════
  {
    envVar: 'KENOSIS', lens: 'egyptian',
    era: '~2200 BCE', eraSort: -2200,
    name: 'Nephthys',
    connotation: 'Lunar receptive — the vessel that lets the dying enter rest.',
    source: 'Funerary texts',
  },
  {
    envVar: 'KENOSIS', lens: 'sanskrit-vedic',
    era: '~200 BCE', eraSort: -200,
    name: 'Shunyata', script: 'शून्यता',
    connotation: 'Emptiness as fullness — the void that holds everything.',
    source: 'Mahayana Buddhism, Nagarjuna',
  },
  {
    envVar: 'KENOSIS', lens: 'greek-classical',
    era: '1st c CE', eraSort: 60,
    name: 'KENOSIS', script: 'κένωσις',
    connotation: 'Self-emptying — laying down what was held to receive more.',
    source: 'Philippians 2:7',
  },
  {
    envVar: 'KENOSIS', lens: 'christian-mystical',
    era: '~600 CE', eraSort: 600,
    name: 'Via Negativa',
    connotation: 'Apophatic emptying — God known by what is removed.',
    source: 'Pseudo-Dionysius',
  },
  {
    envVar: 'KENOSIS', lens: 'jungian',
    era: '20th c', eraSort: 1951,
    name: 'Shadow Integration',
    connotation: 'Releasing the false self so the true self can come forward.',
    source: 'Jung, Aion',
  },
  {
    envVar: 'KENOSIS', lens: 'physics-elemental',
    era: '20th c', eraSort: 1948,
    name: 'Vacuum State',
    connotation: 'Quantum ground state — emptiness teeming with virtual fields.',
    source: 'Casimir effect',
  },
  {
    envVar: 'KENOSIS', lens: 'modern-wellness',
    era: '21st c', eraSort: 2026,
    name: 'Unbecoming',
  ...
  {
    envVar: 'SHATKONA', lens: 'sanskrit-vedic',
    era: '~600 BCE', eraSort: -600,
    name: 'Shatkona', script: 'षट्कोण',
    connotation: 'Six-pointed Shiva-Shakti union — anahata heart geometry.',
    source: 'Tantric yantras',
  },
  {
    envVar: 'SHATKONA', lens: 'greek-classical',
    era: '~300 BCE', eraSort: -300,
    name: 'Hexagram',
  ...
  {
    envVar: 'SHATKONA', lens: 'christian-mystical',
    era: '~1000 CE', eraSort: 1000,
  ...
  {
    envVar: 'SHATKONA', lens: 'physics-elemental',
    era: '17th c', eraSort: 1611,
  ...
  {
    envVar: 'SHATKONA', lens: 'modern-wellness',
    era: '21st c', eraSort: 2026,
    name: 'Alignment',
  ...
  {
    envVar: 'PADMA', lens: 'sanskrit-vedic',
    era: '~1500 BCE', eraSort: -1500,
    name: 'Padma', script: 'पद्म',
    connotation: 'Sacred bloom rising clean from muddy water — sahasrara crown.',
    source: 'Vedas, tantric yoga',
  },
  {
    envVar: 'PADMA', lens: 'greek-classical',
    era: '~700 BCE', eraSort: -700,
    name: 'Lotos', script: 'λωτός',
    connotation: "The fruit that dissolves return-home — Homer's lotus-eaters.",
    source: 'Homer, Odyssey IX',
  },
  {
    envVar: 'PADMA', lens: 'christian-mystical',
    era: '14th c', eraSort: 1320,
    name: 'Mystical Rose',
    connotation: "Dante's celestial rose — saints arranged as petals around God.",
    source: 'Dante, Paradiso XXX',
  },
  {
    envVar: 'PADMA', lens: 'jungian',
    era: '20th c', eraSort: 1955,
    name: 'Self as Mandala',
    connotation: 'Petalled wholeness — the centred unfolding of the Self.',
    source: 'Jung, Mysterium Coniunctionis',
  },
  {
    envVar: 'PADMA', lens: 'physics-elemental',
    era: '20th c', eraSort: 1937,
    name: 'Phase Bloom',
    connotation: 'Order parameter unfolding — symmetry breaking into form.',
    source: 'Landau theory of phase transitions',
  },
  {
    envVar: 'PADMA', lens: 'modern-wellness',
    era: '21st c', eraSort: 2026,
    name: 'The Becoming',
  ...
  {
    envVar: 'BODHI', lens: 'physics-elemental',
    era: '20th c', eraSort: 1927,
    name: 'Coherent State',
  ...
  {
    envVar: 'BODHI', lens: 'modern-wellness',
    era: '21st c', eraSort: 2026,
    name: 'Awakening',
  ...
  // ════════════════════════════════════════════════════════════════
  {
    envVar: 'TETRAD', lens: 'egyptian',
    era: '~2300 BCE', eraSort: -2300,
    name: 'Four Sons of Horus',
    connotation: 'Cardinal guardians — north/south/east/west kept whole.',
    source: 'Egyptian funerary tradition',
  },
  {
    envVar: 'TETRAD', lens: 'sanskrit-vedic',
    era: '~1200 BCE', eraSort: -1200,
    name: 'Chatura / Chatur-vyuha', script: 'चतुर्व्यूह',
    connotation: 'The four directions, four life stages, four divine forms.',
    source: 'Vedas, Pancharatra',
  },
  {
    envVar: 'TETRAD', lens: 'greek-classical',
    era: '~530 BCE', eraSort: -530,
    name: 'Tetraktys', script: 'τετρακτύς',
    connotation: 'The fourfold cosmos — 1+2+3+4 = 10, the perfect figure.',
    source: 'Pythagoras',
  },
  {
    envVar: 'TETRAD', lens: 'christian-mystical',
    era: '~200 CE', eraSort: 200,
  ...
  {
    envVar: 'TETRAD', lens: 'jungian',
    era: '20th c', eraSort: 1921,
    name: 'Four Functions',
    connotation: 'Thinking, feeling, sensation, intuition — the psyche squared.',
    source: 'Jung, Psychological Types',
  },
  {
    envVar: 'TETRAD', lens: 'physics-elemental',
    era: '17th c', eraSort: 1644,
  ...
  {
    envVar: 'TETRAD', lens: 'modern-wellness',
    era: '21st c', eraSort: 2026,
    name: 'Integrate',
  ...
  // ════════════════════════════════════════════════════════════════
  {
    envVar: 'OKTAEDRON', lens: 'egyptian',
    era: '~2300 BCE', eraSort: -2300,
  ...
  {
    envVar: 'OKTAEDRON', lens: 'sanskrit-vedic',
    era: '~500 BCE', eraSort: -500,
    name: 'Ashtakona / Ashtanga', script: 'अष्टकोण / अष्टाङ्ग',
    connotation: 'Eightfold figure — the eightfold path made geometric.',
    source: 'Buddhist tradition, tantric yantras',
  },
  {
    envVar: 'OKTAEDRON', lens: 'greek-classical',
    era: '~360 BCE', eraSort: -360,
    name: 'OKTAEDRON', script: 'ὀκτάεδρον',
    connotation: "Plato's element of air — eight faces, perfect double-pyramid.",
    source: 'Plato, Timaeus',
  },
  {
    envVar: 'OKTAEDRON', lens: 'christian-mystical',
    era: '~400 CE', eraSort: 400,
  ...
  {
    envVar: 'OKTAEDRON', lens: 'physics-elemental',
    era: '19th c', eraSort: 1850,
  ...
  {
    envVar: 'OKTAEDRON', lens: 'modern-wellness',
    era: '21st c', eraSort: 2026,
    name: 'Authenticate',
  ...
  {
    envVar: 'ANKH', lens: 'sanskrit-vedic',
    era: '~1500 BCE', eraSort: -1500,
    name: 'Amrta', script: 'अमृत',
    connotation: 'Deathless nectar — what continues past the body.',
    source: 'Vedas, churning of the ocean',
  },
  {
    envVar: 'ANKH', lens: 'greek-classical',
    era: '~300 BCE', eraSort: -300,
    name: 'Crux Ansata',
    connotation: 'Handled cross — the symbol travels into the Hellenistic world.',
    source: 'Coptic transmission',
  },
  {
    envVar: 'ANKH', lens: 'christian-mystical',
    era: '~400 CE', eraSort: 400,
    name: 'Coptic Cross / Tree of Life',
    connotation: 'Eternal life made cross-shaped — the continued through death.',
    source: 'Coptic Christianity',
  },
  {
    envVar: 'ANKH', lens: 'jungian',
    era: '20th c', eraSort: 1953,
  ...
  {
    envVar: 'ANKH', lens: 'physics-elemental',
    era: '19th c', eraSort: 1847,
  ...
  {
    envVar: 'ANKH', lens: 'modern-wellness',
    era: '21st c', eraSort: 2026,
    name: 'Unlock',
...
export function chainsFor(envVar: EnvVar): SurfaceBinding[] {
  return NAMING_CHAINS
    .filter((b) => b.envVar === envVar)
    .sort((a, b) => (a.eraSort ?? 0) - (b.eraSort ?? 0));
}
